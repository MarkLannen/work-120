...
8. Increased the maximun stroke width to 15 px so that when the ball is very small, the shape appears to be a diaomond.
9. I had wanted to set an if else statement that transformed the ball to a rectangle based on MouseY, but after much experimenting I could not make it happen.  :(
